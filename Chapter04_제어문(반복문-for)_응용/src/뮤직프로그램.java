...
public class 뮤직프로그램 {
	...
	public static void main(String[] args) throws Exception {
		...
		for(;;)
		{
			...
			System.out.println("4. 상승폭이 가장 큰 곡");
			System.out.println("5. 하락폭이 가장 큰 곡");
			...
			{
				System.out.println("***** 상승폭이 가장 큰 곡 *****");
			}
			else if(menu==5)
			{
				System.out.println("***** 하락폭이 가장 큰 곡 *****");
			}
